...
h_re="$(printf '%s' "$h" | sed 's/\./\\./g')"   # escape dots — repo names contain them (e.g. example.github.io-hostname); an unescaped '.' matches ANY char and could false-match a sibling
