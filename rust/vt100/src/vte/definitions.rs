...
// Unused now that `table.rs` pins the generated table as a literal instead
// of invoking the `vte_generate_state_changes` macro (see the comment
// there) — kept because it is what that literal was derived from, and what
// regenerating it by hand needs.
#[allow(dead_code)]
#[inline(always)]
