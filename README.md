...
- **Interactive figures** — `wglshow(fig)` serves a live WGLMakie figure into your browser to pan, zoom, and rotate 3-D over an auto-forwarded port; the figure fills the window and grows with it, and holds up on real multi-part mesh scenes. Static CairoMakie plots still render inline.
